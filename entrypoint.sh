...
python3 -u -c "from huggingface_hub import snapshot_download; snapshot_download(repo_id='${MODEL_REPO}', cache_dir='${MODEL_CACHE}', allow_patterns=['F5-TTS_RUSSIAN/F5TTS_v1_Base/*','F5-TTS_RUSSIAN/F5TTS_v1_Base_v4_winter/*'])"
